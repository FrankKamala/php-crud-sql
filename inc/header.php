					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li class="dummy"><a href="javascript:void(0)"><i class="fa fa-phone"></i> +254 787 160613</a></li>
								<li class="dummy"><a href="javascript:void(0)"><i class="fa fa-envelope"></i> info@dukani.com</a></li>
					...
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								<li class="dummy"><a href="https://api.whatsapp.com/message/XK6X3Z5BLKGME1"><i class="fa fa-facebook"></i></a></li>
								<li class="dummy"><a href="https://twitter.com/Kekick1"><i class="fa fa-twitter"></i></a></li>
								<li class="dummy"><a href="https://www.instagram.com/ke.kick/"><i class="fa fa-instagram"></i></a></li>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.php"><span><h4>DUKANI</h4></span></a>
						</div>
